        ...
        <div class="box-body">
            ...
            <div class="row">
              <div class="col-sm-4 col-sm-offset-4">
                <form method="post" action="<?php echo base_url().'index.php/stockOut/simpan_data' ?>">
                  ...
                  <div class="form-group">
                    <label for="qty">Qty (Jumlah Keluar) *</label>
                    <input type="number" name="qty" class="form-control" required>
                  </div>

                  <button class="btn btn-success" type="submit"><i class="fa fa-save"></i> Simpan</button>
                  <a href="<?php echo base_url().'index.php/stockOut/index' ?>" class="btn btn-danger"><i class="fa fa-refresh"></i> Batal</a>
