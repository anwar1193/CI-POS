              ...
              <?php echo form_open_multipart() ?>
                ...
                <div class="form-group <?php echo form_error('kategori') ? 'has-error' : null ?>">
                  ...
                  <select name="kategori" class="form-control">
                    ...
                    <option value="<?php echo $row_kategori['id'] ?>" <?= $row_kategori['id'] == $row['id_kategori'] ? 'selected' : null ?> ><?php echo $row_kategori['nama'] ?></option>
                    <?php endforeach; ?>
                  </select>
                ...
                <div class="form-group <?php echo form_error('unit') ? 'has-error' : null ?>">
                  ...
                  <select name="unit" class="form-control">
                    ...
                    <option value="<?php echo $row_unit['id'] ?>" <?php echo $row_unit['id'] == $row['id_unit'] ? 'selected' : null ?>><?php echo $row_unit['nama'] ?></option>
                    <?php endforeach; ?>
                  </select>
                ...
                <img src="<?php echo base_url().'uploads/product/'.$row['gambar'] ?>" style="width: 200px"><br>
