...
<body class="hold-transition skin-yellow sidebar-mini <?php echo $this->uri->segment(1) == 'sales' ? 'sidebar-collapse' : null ?>">
<!-- Site wrapper -->
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url().'asset' ?>/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SI</b>POS</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $this->tampil_user->user_login()->username; ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo $this->tampil_user->user_login()->nama_lengkap; ?>
